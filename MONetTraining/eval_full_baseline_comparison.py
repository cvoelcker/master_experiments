...
def main():
    ...
    spatial_monet_config = ConfigGenerator('trained_baselines/spatial-monet/config.yml')
    ...
    for game in all_games:
        ...
        spatial_monet_checkpoint = f'trained_baselines/spatial-monet/checkpoints_{game}/model_state_0000050.save'
        ...
        source_loader = generators.FunctionLoader(
                ...
                {'env': env, 'num_runs': 1, 'run_len': 1000})
